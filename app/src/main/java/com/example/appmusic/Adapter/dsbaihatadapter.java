...
public class dsbaihatadapter extends RecyclerView.Adapter<dsbaihatadapter.ViewHolder>  {
    ...
    public dsbaihatadapter(Context context, ArrayList<Baihat> arrayListbaihat) {
...
//                        mediaPlayer.start();
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Toast.makeText(context,"click vào bai hat", Toast.LENGTH_LONG).show();
                   // Log.d("aa", "onClick:  vao bai hat");

                    Baihat baihat=arrayListbaihat.get(getPosition());
                    if(baihat!=null){
                        intent.putExtra("cakhuc",baihat);
                    }else{
                       // Log.d("aa", "bai hat null");
                    }
